...
//  west dean delicious
//
//  Created by westonnaki on 15/5/11.
...
-(void)loadImage
{
    ...
    @try {
        ...
        //设子请求超时时间为30s
        NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:self.imageURL] cachePolicy:NSURLRequestReloadIgnoringCacheData timeoutInterval:3.0];
