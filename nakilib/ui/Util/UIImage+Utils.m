...
- (UIImage *) maskWithImage:(const UIImage *) maskImage
{
    ...
    const CGContextRef mainViewContentContext = CGBitmapContextCreate (NULL, maskImage.size.width, maskImage.size.height, 8, 0, colorSpace, kCGBitmapByteOrder32Host);
